...
class ShopPostPolicy
{
    ...
    {
        shopHasPermission($aclUser, 'shop_posts::view');
    }
    ...
    public function create(AclUser $aclUser): bool
    {
        ...
        $hasPermissionChucNang = shopHasPermission($aclUser, 'shop_posts::create');
    ...
    {
        $hasPermissionChucNang = shopHasPermission($aclUser, 'shop_posts::update');
