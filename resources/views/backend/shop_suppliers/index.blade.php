    ...
    <table class="table table-bordered">
        ...
        @foreach ($dsShopSuppliers as $sup)
            <tr>
                <td>{{ $sup->id }}</td>
                <td>
                    <img src="/storage/uploads/{{ $sup->image }}" class="img-fluid hinh-anh-dai-dien"
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-delete" data-id="{{ $sup->id }}"
                        data-delete-url="{{ route('backend.shop_suppliers.destroy', ['id' => $sup->id]) }}">Xóa</button>
                </td>
            </tr>
        @endforeach
    </table>
