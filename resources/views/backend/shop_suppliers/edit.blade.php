...
@section('main-content')
    ...
    <form name="frmUpdate" method="post" action="{{ route('backend.shop_suppliers.update', ['id' => $updatingModel->id]) }}"
        ...
        <div>
            ...
            <input type="text" name="supplier_code" class="form-control" id="supplier_code"
                placeholder="Mời nhập mã nhà cung cấp" value="{{ old('supplier_code', $updatingModel->supplier_code) }}">
        </div>
        ...
        <div>
            ...
            <input type="text" name="supplier_name" class="form-control" id="supplier_name"
                placeholder="Mời nhập tên nhà cung cấp" value="{{ old('supplier_name', $updatingModel->supplier_name) }}">
        </div>
        ...
        <div class="mt-2">
            <a href="{{ route('backend.shop_suppliers.index') }}"
