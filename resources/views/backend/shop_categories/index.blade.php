    ...
    <table class="table table-bordered">
        ...
        @foreach ($dsShopCategories as $cat)
            <tr>
                <td>{{ $cat->id }}</td>
                <td>
                    <img src="/storage/uploads/{{ $cat->image }}" class="img-fluid hinh-anh-dai-dien"
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-delete" data-id="{{ $cat->id }}"
                        data-delete-url="{{ route('backend.shop_categories.destroy', ['id' => $cat->id]) }}">Xóa</button>
                </td>
            </tr>
        @endforeach
    </table>
