...
@section('main-content')
    ...
    <form name="frmCreate" method="post" action="{{ route('backend.shop_posts.store') }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" name="post_slug" class="form-control" id="post_slug" placeholder="Mời nhập địa chỉ bài viết"
                value="{{ old('post_slug') }}">
        </div>
        ...
        <div class="row">
            <div class="col-6">
                <div>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="post_type" id="post_type_1" value="post"
                            checked>
            ...
            <div class="col-6">
                <div>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="post_status" id="post_status_1" value="draft"
                            checked>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="post_status" id="post_status_2"
                            value="publish">
        ...
        <div class="mt-2">
            <a href="{{ route('backend.shop_posts.index') }}"
                class="btn btn-outline-secondary waves-effect waves-light material-shadow-none">Quay về Danh sách</a>
