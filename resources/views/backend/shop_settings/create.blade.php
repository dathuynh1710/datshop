        ...
        <div class="card-body">
            ...
            <form name="frmCreate" id="frmCreate" method="post" action="{{ route('backend.shop_settings.store') }}">
                    ...
                    <div class="col-6">
                        <div>
                            ...
                            <input type="text" name="key" class="form-control" id="key"
                                placeholder="Mời nhập key" value="{{ old('key') }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div>
                            ...
                            <input type="text" name="value" class="form-control" id="value"
                                placeholder="Mời nhập giá trị" value="{{ old('value') }}">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" class="form-control ckeditor-classic" id="description" placeholder="Mời nhập diễn giải"></textarea>
                </div>
