...
<head>
    ...
    <meta content="Bán hàng uy tín tại Long Xuyên, các mặt hàng về điện thoại, laptop" name="description" />
    <meta content="Bán hàng Long Xuyên, điện thoại Long Xuyên" name="keywords" />
    <meta content="Huỳnh Thành Đạt" name="author" />
    <!-- App favicon -->
    ...
    <link href="{{ asset('assets/css/datshop.css') }}" rel="stylesheet" type="text/css" />
